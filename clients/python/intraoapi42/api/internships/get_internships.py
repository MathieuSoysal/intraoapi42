...
from ...models.internship_response import InternshipResponse
...
) -> Error | list[InternshipResponse]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = InternshipResponse.from_dict(response_200_item_data)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | list[InternshipResponse]]:
    return Response(
...
def sync(
    *,
    ...
    pagenumber: int | Unset = UNSET,
    pagesize: int | Unset = UNSET,
) -> Error | list[InternshipResponse] | None:
    """Get a list of internships
