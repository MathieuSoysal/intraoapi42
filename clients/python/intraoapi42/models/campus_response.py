...
T = TypeVar("T", bound="CampusResponse")
...
class CampusResponse:
    ...
    Attributes:
        ...
        public (bool):
        email_extension (str):
        language (LanguageResponse | Unset):
        address (str | Unset):
        zip_ (str | Unset):
        website (str | Unset):
        facebook (str | Unset):
    ...
    public: bool
    email_extension: str
    language: LanguageResponse | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_language, Unset):
            ...
            language = LanguageResponse.from_dict(_language)
        ...
        campus_response.additional_properties = d
