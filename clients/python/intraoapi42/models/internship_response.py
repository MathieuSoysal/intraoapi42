...
if TYPE_CHECKING:
    from ..models.internship_response_convention import InternshipResponseConvention
    from ..models.light_user_response import LightUserResponse


T = TypeVar("T", bound="InternshipResponse")
...
class InternshipResponse:
    ...
    Attributes:
        ...
        convention (InternshipResponseConvention):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        convention = InternshipResponseConvention.from_dict(d.pop("convention"))
        ...
        internship_response.additional_properties = d
