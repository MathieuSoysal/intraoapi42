...
if TYPE_CHECKING:
    from ..models.question_with_answers_response import QuestionWithAnswersResponse
    from ..models.scale_flag_response import ScaleFlagResponse
    from ..models.scale_team_response_truant import ScaleTeamResponseTruant
    from ..models.scale_user_response import ScaleUserResponse
    from ..models.team_upload_response import TeamUploadResponse


T = TypeVar("T", bound="ScaleTeamResponse")


@_attrs_define
class ScaleTeamResponse:
    """
    Attributes:
        id (int):
        scale_id (int):
        ...
        feedback (str):
        final_mark (int | None):
        flag (ScaleFlagResponse):
        begin_at (datetime.datetime):
        correcteds (list[ScaleUserResponse]):
        corrector (ScaleUserResponse):
        truant (ScaleTeamResponseTruant):
        filled_at (datetime.datetime | None):
        questions_with_answers (list[QuestionWithAnswersResponse]):
        teams_uploads (list[TeamUploadResponse] | Unset):
    """
    ...
    filled_at: datetime.datetime | None
    questions_with_answers: list[QuestionWithAnswersResponse]
    teams_uploads: list[TeamUploadResponse] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        flag = ScaleFlagResponse.from_dict(d.pop("flag"))
        ...
        for correcteds_item_data in _correcteds:
            correcteds_item = ScaleUserResponse.from_dict(correcteds_item_data)

            correcteds.append(correcteds_item)

        corrector = ScaleUserResponse.from_dict(d.pop("corrector"))

        truant = ScaleTeamResponseTruant.from_dict(d.pop("truant"))
        ...
        for questions_with_answers_item_data in _questions_with_answers:
            questions_with_answers_item = QuestionWithAnswersResponse.from_dict(questions_with_answers_item_data)
        ...
        if _teams_uploads is not UNSET:
            ...
            for teams_uploads_item_data in _teams_uploads:
                teams_uploads_item = TeamUploadResponse.from_dict(teams_uploads_item_data)

                teams_uploads.append(teams_uploads_item)

        scale_team_response = cls(
            id=id,
            scale_id=scale_id,
            comment=comment,
            created_at=created_at,
        ...
        scale_team_response.additional_properties = d
        return scale_team_response
