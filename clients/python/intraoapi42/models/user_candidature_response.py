...
from ..models.user_candidature_response_gender import (
    UserCandidatureResponseGender,
    check_user_candidature_response_gender,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="UserCandidatureResponse")


@_attrs_define
class UserCandidatureResponse:
    """
    Example:
        {'id': 42, 'user_id': 42, 'birth_date': '2013-01-01', 'gender': 'male', 'zip_code': '75017', 'country':
            'France', 'birth_city': 'Paris', 'birth_country': 'France', 'postal_street': '96 boulevard Bessières',
            'postal_complement': None, 'postal_city': 'Paris', 'postal_zip_code': '75017', 'postal_country': 'France',
            'contact_affiliation': 'Parent', 'contact_last_name': 'Moulinette', 'contact_first_name': 'Norminette',
            'contact_phone1': '+33600000000', 'contact_phone2': None, 'max_level_memory': None, 'max_level_logic': None,
            'other_information': None, 'language': 'fr', 'meeting_date': '2020-08-27T07:31:49.431Z', 'piscine_date': None,
            'created_at': '2020-08-27T07:31:49.431Z', 'updated_at': '2025-07-10T16:16:34.238Z', 'phone': '+33600000000',
            'email': 'tmatis@example.com', 'pin': '7777', 'phone_country_code': 'FR', 'hidden_phone': False}
    ...
    Attributes:
        ...
        gender (UserCandidatureResponseGender | Unset):
    ...
    gender: UserCandidatureResponseGender | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = check_user_candidature_response_gender(_gender)
        ...
        user_candidature_response.additional_properties = d
        return user_candidature_response
