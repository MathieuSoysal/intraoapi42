...
T = TypeVar("T", bound="UserImageResponseVersions")


@_attrs_define
class UserImageResponseVersions:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_image_response_versions = cls(
            large=large,
            medium=medium,
            small=small,
            micro=micro,
        ...
        user_image_response_versions.additional_properties = d
        return user_image_response_versions
