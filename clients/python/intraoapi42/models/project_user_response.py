...
if TYPE_CHECKING:
    from ..models.light_project_response import LightProjectResponse
    from ..models.light_team_response import LightTeamResponse
...
class ProjectUserResponse:
    ...
    Attributes:
        ...
        validated (bool | None):
        current_team_id (int):
        project (LightProjectResponse):
        cursus_ids (list[int]):
        user (LightUserResponse):
        teams (list[LightTeamResponse]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project = LightProjectResponse.from_dict(d.pop("project"))
        ...
        for teams_item_data in _teams:
            teams_item = LightTeamResponse.from_dict(teams_item_data)
