...
T = TypeVar("T", bound="LightUserResponse")


@_attrs_define
class LightUserResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        light_user_response.additional_properties = d
        return light_user_response
